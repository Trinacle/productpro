    ...
    <a href="<?php echo esc_url( 'https://app.f13commerce.com/register' ); ?>" class="foot-mini-cta">
        ...
        <span>Download WooCommerce Plugin</span>
                ...
                <div class="foot-social">
                    <a href="https://www.facebook.com/productpro" aria-label="Facebook" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.56 9.88v-6.99H7.9V12h2.54V9.8c0-2.5 1.49-3.89 3.78-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.89h-2.34v6.99A10 10 0 0 0 22 12z"/></svg></a>
                    <a href="https://x.com/productpro" aria-label="X" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2H21.5l-7.5 8.57L22.5 22h-6.844l-5.36-7.01L4.16 22H.9l8.02-9.17L1.5 2h6.99l4.84 6.4L18.244 2z"/></svg></a>
                    <a href="https://www.youtube.com/@productpro" aria-label="YouTube" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M22 8.5a3 3 0 0 0-2.1-2.1C18 6 12 6 12 6s-6 0-7.9.4A3 3 0 0 0 2 8.5 31 31 0 0 0 2 12a31 31 0 0 0 .1 3.5 3 3 0 0 0 2 2.1C6 18 12 18 12 18s6 0 7.9-.4a3 3 0 0 0 2.1-2.1A31 31 0 0 0 22 12a31 31 0 0 0-.1-3.5z"/><polygon points="10 9 15 12 10 15" fill="currentColor"/></svg></a>
                </div>
            </div>
            <div class="foot-col">
                <h5>Platforms</h5>
            ...
            <div class="foot-col">
                ...
                <a href="<?php echo esc_url( home_url( '/brand/lelo/' ) ); ?>">LELO</a>
                <a href="<?php echo esc_url( home_url( '/brand/blush/' ) ); ?>">Blush</a>
                <a href="<?php echo esc_url( home_url( '/brand/we-vibe/' ) ); ?>">We-Vibe</a>
                <a href="<?php echo esc_url( home_url( '/brand/pipedream/' ) ); ?>">Pipedream</a>
        ...
        <div class="foot-bottom">
            <div>&copy; <span data-year><?php echo esc_html( date( 'Y' ) ); ?></span> ProductPro. &nbsp;
