<?php
/**
 * The front page — ProductPro homepage.
 *
...
// Real integration logo URLs (verified working on productpro.io)
...
<main>
    ...
    <!-- ===== PRODUCTS SECTION (real copy from productpro.io) ===== -->
      ...
      <div class="wrap">
        ...
        <div class="dual">
          ...
          <div class="dual-card supplier reveal reveal-d1">
            ...
            <p class="lede">List your catalog once and reach hundreds of retailers. ProductPro handles the listings, orders, payments, and routing. You focus on fulfillment.</p>
            <ul class="checks">
      ...
      <div class="wrap">
        ...
        <div class="getting-started">
          <div class="gs-card reveal">
            ...
            <h4>Create your ProductPro account</h4>
            <p>Start your 7-day free trial as a retailer or supplier at /signup. Takes less than a minute to get started.</p>
          </div>
          <div class="gs-card reveal reveal-d1">
            ...
            <p><strong>Shopify:</strong> Install the ProductPro app from the Shopify App Store. <strong>WooCommerce:</strong> Download the ProductPro WordPress plugin. <strong>BigCommerce:</strong> Install from the BigCommerce marketplace. One click links your store.</p>
          </div>
    ...
    <section class="sec">
      <div class="wrap">
        ...
        <div class="center reveal reveal-d3" style="margin-top:40px;">
          <a href="https://apps.shopify.com/air-waves-apparel" class="link-arrow" style="font-size:1.05rem;">Read more reviews on the Shopify App Store <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
        </div>
      </div>
    </section>
      ...
      <div class="wrap wrap-tight">
        ...
        $sdn_home_faqs = array(
            ...
            array(
                ...
                'a'    => 'Install the ProductPro app from the Shopify App Store, connect your store, and import products from the catalog. Orders sync automatically once a customer checks out.',
                'slug' => 'how-to-start-dropshipping-on-shopify',
            ),
            array(
            ...
            array(
                ...
                'a'    => 'When a customer orders from your store, ProductPro routes the order to the supplier, who fulfills and ships it. Order status and tracking sync back to your store automatically.',
                'slug' => 'how-dropship-orders-are-processed',
            ),
            array(
                'q'    => 'How do I find good suppliers?',
                'a'    => 'Look for suppliers with real-time inventory sync, transparent wholesale pricing, and no per-order fees. ProductPro\'s marketplace gives you access to hundreds of vetted suppliers in one place.',
                'slug' => 'what-are-the-best-suppliers-for-dropshipping',
            ),
            array(
                'q'    => 'How does product pricing work?',
                'a'    => 'You buy at the supplier\'s wholesale price and set your own retail price in your store &mdash; ProductPro doesn\'t take a cut of that margin.',
    ...
    <!-- ===== SHOPPING CART INTEGRATIONS (real copy from productpro.io) ===== -->
    ...
    <!-- ===== REAL TESTIMONIALS (from productpro.io) ===== -->
    <section class="sec">
      <div class="wrap">
        <div class="center" style="max-width:760px;margin:0 auto 56px;">
