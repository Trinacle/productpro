<?php
/**
 * ProductPro — child theme functions
 *
 * @package ProductPro
 */
...
function sdn_theme_setup() {
    ...
    register_nav_menus( array(
        'solutions' => __( 'Mega Menu: Solutions', 'productpro' ),
        'brands'    => __( 'Mega Menu: Brands', 'productpro' ),
        'mobile'    => __( 'Mobile Menu', 'productpro' ),
        'footer_platform' => __( 'Footer: Platform', 'productpro' ),
        'footer_brands'   => __( 'Footer: Brands', 'productpro' ),
        'footer_resources' => __( 'Footer: Resources', 'productpro' ),
    ) );
}
...
/**
 * These templates reproduce the ProductPro static prototype exactly and use
...
function sdn_flag_bespoke_template( $template ) {
    $bespoke = array(
        ...
        'page-solutions.php', 'page-resources.php', 'page-signup.php',
...
define( 'SDN_OG_IMAGE', '/wp-content/uploads/2024/06/productpro-600x338.webp' );
...
function sdn_yoast_title( $title ) {
    ...
    if ( preg_match( '#^brand/([a-z0-9-]+)/?$#i', $path, $bm ) ) {
        ...
        if ( $bname ) {
            return 'Dropship & Wholesale ' . $bname . ' Products | ProductPro';
        }
    }
    return $title;
}
...
function sdn_schema() {
    ...
    $org = array(
        ...
        'sameAs'   => array(
            ...
            'https://www.youtube.com/@productpro',
