...
<header class="site">
    ...
    <div class="nav-cta">
        ...
        <a href="https://app.f13commerce.com/login" class="header-search-btn" aria-label="Log in">
        ...
        <div class="mega-panels">
            ...
            <div class="mega-panel" data-panel="solutions">
                <div class="mega-grid">
                    ...
                    <a class="mega-link" href="<?php echo esc_url( home_url( '/platform' ) ); ?>"><strong>Platform Overview</strong><span>How ProductPro works</span></a>
                    ...
                    <a class="mega-link" href="<?php echo esc_url( home_url( '/demo' ) ); ?>"><strong>Get a Demo</strong><span>See ProductPro in action</span></a>
                </div>
            </div>
