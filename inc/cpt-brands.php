...
function sdn_register_brand_cpt() {
    ...
    $labels = array(
        'name'                  => __( 'Brands', 'productpro' ),
        'singular_name'         => __( 'Brand', 'productpro' ),
        'menu_name'             => __( 'Brands', 'productpro' ),
        'name_admin_bar'        => __( 'Brand', 'productpro' ),
        'add_new'               => __( 'Add New Brand', 'productpro' ),
        'add_new_item'          => __( 'Add New Brand', 'productpro' ),
        'new_item'              => __( 'New Brand', 'productpro' ),
        'edit_item'             => __( 'Edit Brand', 'productpro' ),
        'view_item'             => __( 'View Brand', 'productpro' ),
        'all_items'             => __( 'All Brands', 'productpro' ),
        'search_items'          => __( 'Search Brands', 'productpro' ),
        'parent_item_colon'     => __( 'Parent Brand:', 'productpro' ),
        'not_found'             => __( 'No brands found.', 'productpro' ),
        'not_found_in_trash'    => __( 'No brands found in Trash.', 'productpro' ),
        'featured_image'        => __( 'Brand Hero Image', 'productpro' ),
        'set_featured_image'    => __( 'Set brand hero image', 'productpro' ),
        'remove_featured_image' => __( 'Remove brand hero image', 'productpro' ),
        'use_featured_image'    => __( 'Use as brand hero image', 'productpro' ),
    );
...
function sdn_seed_real_brands() {
    ...
    foreach ( $all as $b ) {
        ...
        $post_id = wp_insert_post( array(
            ...
            'post_title'   => $b['name'],
            'post_name'    => $slug,
            'post_content' => $b['name'] . ' products are available for dropship and wholesale on ProductPro. Import to your store in a few clicks, with automatic inventory sync and blind dropshipping.',
        ) );
