 ...
 *
 * ProductPro vs Crowdship, Spocket, Duoplane — competitor comparison.
 *
 * @package ProductPro
 */
...
<main>
    ...
    <section class="sec" style="background:var(--bg-2);">
      <div class="wrap wrap-tight center">
        ...
        <h2 class="display reveal reveal-d1" style="margin-top:24px;">Switch to ProductPro.<br><span class="italic gradient-text">Keep your margin.</span></h2>
        ...
        <a href="https://app.f13commerce.com/register" class="btn btn-lime btn-lg reveal reveal-d3" style="margin-top:32px;">Start free migration</a>
      </div>
    </section>
</main>
