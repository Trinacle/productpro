 ...
 *
 * Contact page — real ProductPro contact info + the site's existing
    ...
    <section class="sec" style="padding-top:40px;">
      <div class="wrap">
        <div class="contact-methods">
          <a href="mailto:support@productpro.io" class="cm-card reveal">
          ...
          <div class="contact-info">
            ...
            <div class="ci-item">
              ...
              <div>
                ...
                <a href="mailto:support@productpro.io">support@productpro.io</a>
              </div>
            </div>
            ...
            <div class="ci-item">
              ...
              <div>
                <span class="ci-label">New to ProductPro?</span>
