...
<main>
    <section class="page-hero">
      ...
      <div class="ph-inner center">
        ...
        <h1 class="display reveal reveal-d1" style="margin:24px 0;">See ProductPro<br><span class="italic gradient-text">in action.</span></h1>
        <p class="lede reveal reveal-d2" style="max-width:560px;margin:0 auto;">Request a demo to learn more about what ProductPro can do for your business.</p>
      </div>
    </section>
    ...
    <section class="sec" style="padding-top:0;">
      <div class="wrap wrap-tight">
        <?php if ( $submitted ) : ?>
          <div class="form-success reveal">Thanks &mdash; we've got your request. A ProductPro team member will reach out shortly.</div>
        <?php else : ?>
          <?php if ( $error ) : ?>
