...
<main>
    <section class="page-hero">
      ...
      <div class="ph-inner center">
        ...
        <p class="lede reveal reveal-d2" style="max-width:600px;margin:0 auto;">The ProductPro WooCommerce plugin connects your store to the full marketplace &mdash; import products, sync inventory, and automate order fulfillment with no transaction fees.</p>
        ...
        <div class="bento" style="grid-template-columns:repeat(3,1fr);gap:24px;">
          ...
          <div class="bento-cell dark reveal reveal-d1">
            <div class="inner" style="text-align:center;">
              ...
              <p>Enter your ProductPro API key to link your WooCommerce store to the marketplace.</p>
            </div>
          </div>
        ...
        <div class="tool-row reveal">
          ...
          <div class="tool-body">
            <div class="tool-checks">
              ...
              <div class="tool-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg><span>An active ProductPro account (free trial available)</span></div>
            </div>
            <a href="<?php echo esc_url( $register ); ?>" class="btn btn-lime btn-lg">Download the Plugin</a>
          </div>
        </div>
