...
$sdn_help = array(
    'Getting Started' => array(
        array( 'How do I create a ProductPro account?',
            'Sign up free at app.productpro.io. No credit card required — you get full catalog access during the 14-day trial.' ),
        array( 'How do I connect my Shopify / WooCommerce / BigCommerce store?',
            'Install the ProductPro app from your platform\'s app store, or download the WooCommerce plugin. One click links your store and starts the inventory sync.' ),
    ...
    'Dropshipping' => array(
        array( 'How does blind dropshipping work?',
            'When a customer orders from you, ProductPro routes it to the right supplier, who ships under your brand with white-label packing slips. Your customer never sees our name.' ),
    ...
    'Account & Billing' => array(
        ...
        array( 'Are there transaction fees or commissions?',
            'No. ProductPro charges one flat monthly (or yearly) plan fee. No transaction fees and no commissions on anything you buy or sell.' ),
