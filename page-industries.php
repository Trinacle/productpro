 ...
 *
 * Dropshipping by vertical — the industries ProductPro serves. Expanded to
    ...
    <section class="sec" style="background:var(--bg-2);">
      <div class="wrap">
        <div class="center" style="max-width:760px;margin:0 auto 56px;">
          <p class="eyebrow reveal" style="justify-content:center;">Why suppliers choose ProductPro</p>
