...
<main>
    <section class="page-hero">
      ...
      <div class="ph-inner center">
        ...
        <p class="lede reveal reveal-d2" style="max-width:560px;margin:0 auto;">Last updated <?php echo esc_html( get_the_modified_date( 'F j, Y' ) ); ?>. Questions? Email <a href="mailto:support@productpro.io" style="color:var(--green-xl);">support@productpro.io</a>.</p>
      </div>
    </section>
