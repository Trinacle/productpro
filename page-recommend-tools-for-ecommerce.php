 ...
 *
 * Curated directory of partner tools that pair well with a ProductPro store:
...
<main>
    <section class="page-hero">
      ...
      <div class="ph-inner center">
        ...
        <p class="lede reveal reveal-d2" style="max-width:600px;margin:0 auto;">Vetted services that pair with ProductPro &mdash; merchant processing, web design, and shipping protection from partners we trust.</p>
      </div>
    </section>
      ...
      <div class="wrap">
        <div class="tool-row reveal">
          ...
          <div class="tool-body">
            ...
            <div class="tool-meta">
              <p><strong>Qualification:</strong> Start-ups selling ProductPro products welcome. No minimum sales volume. Valid business documentation required.</p>
