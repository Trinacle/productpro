...
<main>
    <section class="page-hero">
      ...
      <div class="ph-inner center">
        ...
        <p class="lede reveal reveal-d2" style="max-width:580px;margin:0 auto;">Everything you need to get the most out of ProductPro &mdash; from setup guides to the e-commerce stack we recommend.</p>
      </div>
    </section>
      ...
      <div class="wrap">
        <div class="contact-methods">
          ...
          <a href="<?php echo esc_url( $testi_url ); ?>" class="cm-card reveal">
            ...
            <span class="cm-note">Real stories from stores growing with ProductPro</span>
          </a>
