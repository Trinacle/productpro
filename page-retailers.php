    ...
    <section class="sec" id="how" style="background:var(--bg-2);">
      <div class="wrap">
        ...
        <div class="center reveal reveal-d3" style="margin-top:48px;">
          <a href="https://apps.shopify.com/air-waves-apparel" class="btn btn-lime btn-lg">Install on Shopify <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
        </div>
      </div>
    </section>
