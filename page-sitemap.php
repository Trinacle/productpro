...
<main>
    <section class="page-hero" style="min-height:auto;padding-bottom:60px;">
      ...
      <div class="ph-inner center">
        ...
        <h1 class="display reveal reveal-d1" style="margin:24px 0;">Find your way<br><span class="italic gradient-text">around ProductPro.</span></h1>
      ...
      <div class="wrap">
        <div class="sitemap-grid-full reveal">
          ...
          <div class="foot-col">
            ...
            <a href="<?php echo esc_url( home_url( '/optimize-your-program' ) ); ?>">Optimize Your Program</a>
          </div>
