 ...
 *
 * Features breakdown — every ProductPro capability organized by category.
...
<main>
    <section class="page-hero">
      ...
      <div class="ph-inner center">
        ...
        <p class="lede reveal reveal-d2" style="max-width:600px;margin:0 auto;">From real-time inventory sync to automatic order fulfillment &mdash; ProductPro handles the operational heavy lifting so you can focus on growing your store.</p>
    ...
    <section class="sec" style="background:var(--bg-2);">
      <div class="wrap">
        ...
        <div class="feat-grid">
          ...
          <div class="feat-card reveal reveal-d2"><div class="fc-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 15-6.7L21 8"/><path d="M21 3v5h-5"/></svg></div><h4>300+ brands, 20,000+ products</h4><p>The deepest catalog in adult, intimacy, wellness, and lingerie &mdash; all dropship-ready.</p></div>
        </div>
