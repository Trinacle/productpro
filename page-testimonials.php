...
$sdn_testis = array(
    ...
    array( 'mark' => 'SG', 'name' => 'Rose & Ember', 'role' => 'Online Retailer', 'grad' => '145deg,#c44551,#e55d5c',
    ...
    array( 'mark' => 'MR', 'name' => 'Lace & Luxe', 'role' => 'Online Retailer', 'grad' => '145deg,#8b2935,#c44551',
    ...
    array( 'mark' => 'JR', 'name' => 'Jess Ramirez', 'role' => 'Owner, Velvet & Lace Boutique', 'grad' => '145deg,#c44551,#e55d5c',
    ...
    array( 'mark' => 'HK', 'name' => 'Indigo Intimates', 'role' => 'Online Retailer', 'grad' => '145deg,#8b2935,#c44551',
...
<main>
  <section class="page-hero">
    ...
    <div class="ph-inner center">
      ...
      <p class="lede reveal reveal-d2" style="max-width:620px;margin:0 auto;">Real reviews from ProductPro retailers on the Shopify App Store and beyond.</p>
    </div>
  </section>
  ...
  <section class="sec">
    <div class="wrap">
      ...
      <div class="center reveal" style="margin-top:56px;">
        ...
        <p style="color:var(--ink-mute);margin-top:16px;font-size:.9rem;">Want to see ProductPro in action? <a href="<?php echo esc_url( $demo_url ); ?>" style="color:var(--green-xl);">Get a demo &rarr;</a></p>
      </div>
    </div>
  </section>
