  ...
  <section class="sec">
    <div class="wrap">
      <div style="max-width:780px;margin-bottom:64px;">
        <p class="eyebrow reveal">Why wholesalers buy on ProductPro</p>
    ...
    <div class="wrap">
      ...
      <div class="getting-started">
        <div class="gs-card reveal"><span class="gs-num">01</span>
          ...
          <h4>Create your wholesale account</h4><p>Sign up at /signup. Get vetted for wholesale pricing &mdash; no minimum order amount.</p>
        </div>
