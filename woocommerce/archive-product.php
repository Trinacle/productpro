 ...
 *
 * Bespoke ProductPro marketplace: dark hero, product card grid on WC's
      ...
      <div class="shop-layout">
        ...
        <div class="shop-main">
          ...
          <div class="login-cta-banner">
            <p>Want to see every product? <a href="<?php echo esc_url( $register ); ?>">Log in or create a free account</a> to access the full ProductPro catalog.</p>
          </div>
        </div>
